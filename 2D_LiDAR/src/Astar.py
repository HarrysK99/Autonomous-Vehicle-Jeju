...
def callback_map(data):
    grid_map=np.array(data.data)
    grid_map=grid_map.reshape(40,70)
    grid_map=grid_map.tolist()
    start_point=(20, 0)
    end_point=(20,69)
    points=aStar(grid_map, start_point, end_point)
    # print(points)
    ...
    for point in points:
        ...
        pose_stamped.pose.position.x=point[1]*0.1
        pose_stamped.pose.position.y=(point[0] - 20)*0.1
...
sub=rospy.Subscriber('/grid_map',OccupancyGrid, callback_map)
